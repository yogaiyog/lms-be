...
const stringUuid = { type: "string", format: "uuid" };
const stringDate = { type: "string", format: "date-time" };
const baseSchemas = {
    ErrorResponse: {
        type: "object",
        properties: {
...
function crudPaths(basePath, schemaName, requestSchemaName) {
...
const swaggerDoc = {
    ...
    info: {
        ...
        version: "0.1.0",
        description: "Express + Prisma API untuk LMS dengan auth refresh token rotation dan CRUD modular.",
    },
    servers: [
        {
            url: "/",
    ...
    paths: {
        ...
        ...crudPaths("api/v1/gamification/student-badges", "StudentBadge", "StudentBadge"),
    },
    components: {
        securitySchemes: {
            bearerAuth,
