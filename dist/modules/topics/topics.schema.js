...
exports.topicCreateSchema = zod_1.z.object({
    ...
    materialLink: zod_1.z.string().url().optional().nullable().or(zod_1.z.literal("")),
    exampleProjectLink: zod_1.z.string().url().optional().nullable().or(zod_1.z.literal("")),
    videoYoutubeUrl: zod_1.z.string().url().optional().nullable().or(zod_1.z.literal("")),
    videoUploadUrl: zod_1.z.string().url().optional().nullable().or(zod_1.z.literal("")),
