...
INSERT INTO "new_Class" ("batch", "category", "createdAt", "curriculumId", "id", "isActive", "name", "startDate", "tutorId", "updatedAt") SELECT "batch", "category", "createdAt", "curriculumId", "id", "isActive", "name", "startDate", "tutorId", "updatedAt" FROM "Class";
DROP TABLE "Class";
